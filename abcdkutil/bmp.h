 ...
 * 
 */
#ifndef ABCDKUTIL_BMP_H
#define ABCDKUTIL_BMP_H
 ...
 * 保存BMP图像。
*/
int abcdk_bmp_save2(const char *file, const uint8_t *data, uint32_t stride, uint32_t width, int32_t height, uint8_t bits);
