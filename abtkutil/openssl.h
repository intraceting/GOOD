 ...
 * 
 */
#ifndef ABTKUTIL_OPENSSL_H
#define ABTKUTIL_OPENSSL_H
 ...
 * HMAC支持的算法。
*/
enum _abtk_openssl_hmac_type
{
    ABTK_OPENSSL_HMAC_MD2 = 1,
#define ABTK_OPENSSL_HMAC_MD2 ABTK_OPENSSL_HMAC_MD2

    ABTK_OPENSSL_HMAC_MD4 = 2,
#define ABTK_OPENSSL_HMAC_MD4 ABTK_OPENSSL_HMAC_MD4

    ABTK_OPENSSL_HMAC_MD5 = 3,
#define ABTK_OPENSSL_HMAC_MD5 ABTK_OPENSSL_HMAC_MD5

    ABTK_OPENSSL_HMAC_SHA = 4,
#define ABTK_OPENSSL_HMAC_SHA ABTK_OPENSSL_HMAC_SHA

    ABTK_OPENSSL_HMAC_SHA1 = 5,
#define ABTK_OPENSSL_HMAC_SHA1 ABTK_OPENSSL_HMAC_SHA1

    ABTK_OPENSSL_HMAC_SHA224 = 6,
#define ABTK_OPENSSL_HMAC_SHA224 ABTK_OPENSSL_HMAC_SHA224

    ABTK_OPENSSL_HMAC_SHA256 = 7,
#define ABTK_OPENSSL_HMAC_SHA256 ABTK_OPENSSL_HMAC_SHA256

    ABTK_OPENSSL_HMAC_SHA384 = 8,
#define ABTK_OPENSSL_HMAC_SHA384 ABTK_OPENSSL_HMAC_SHA384

    ABTK_OPENSSL_HMAC_SHA512 = 9,
#define ABTK_OPENSSL_HMAC_SHA512 ABTK_OPENSSL_HMAC_SHA512

    ABTK_OPENSSL_HMAC_RIPEMD160 = 10,
#define ABTK_OPENSSL_HMAC_RIPEMD160 ABTK_OPENSSL_HMAC_RIPEMD160

    ABTK_OPENSSL_HMAC_WHIRLPOOL = 11
#define ABTK_OPENSSL_HMAC_WHIRLPOOL ABTK_OPENSSL_HMAC_WHIRLPOOL
};
