 ...
 * 检查内外版本号是否一致。
*/
#if GOOD_VERSION_MAJOR != BUILD_VERSION_MAJOR
#error "GOOD_VERSION_MAJOR must be equal to BUILD_VERSION_MAJOR"
#endif

/*
 * 检查内外版本号是否一致。
*/
#if GOOD_VERSION_MINOR != BUILD_VERSION_MINOR
#error "GOOD_VERSION_MINOR must be equal to BUILD_VERSION_MINOR"
#endif
